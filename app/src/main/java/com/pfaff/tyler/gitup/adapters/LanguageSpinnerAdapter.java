...
public class LanguageSpinnerAdapter implements SpinnerAdapter {
    ...
    public LanguageSpinnerAdapter(Context context,List<String> items){
        this.items = items;
    ...
    public View getDropDownView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tv = (TextView)convertView.findViewById(R.id.language_text_view);
